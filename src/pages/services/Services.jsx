      ...
      <div className="S_Wrapper">
        <div className="S_Left">
          <div className="S_title">
            ...
            <h3>
              WE PROVIDE A BARRAGE OF <span className="S_Green">ENERGY</span>{" "}
              RELATED SERVICES
            </h3>
            <p>
              Below are some benefits of working with us and the services we
              offer
            </p>
          </div>
          <div className="s_values">
            <div>
              <div className="values_icon"></div>
            ...
            <div>
              ...
              <div className="values_text">
                ...
                <p>
                  We are equipped with a team of highly efficient and
        ...
        <div className="S_Right">
          ...
          <div className="servives_holder">
            {isPageWide ? null : (
              <button
                className="S_Left_Button"
                onClick={() =>
                  sideScroll(
                    document.querySelector(".services_card"),
                    "left",
                    25,
                    250,
                    10
